        ...
        <form action="{{ url('/salida/' . $salida->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="integer" class="form-control" name="cant_salida"
                    value="{{isset($salida->cant_salida) ? $salida->cant_salida : old('cant_salida')}}" placeholder="Escriba la cantidad de salida"
                    id="cant_salida">
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 text-center">
                ...
                <a href="{{ url('salida/nutricion') }}" class="btn btn-success"> Regresar </a>
            </div>
        </form>
    </div>
@endsection
