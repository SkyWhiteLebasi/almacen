                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">
                                    ...
                                    <a href="{{ url('categoria/create') }}" type="button" class="btn btn-pastel1"> <i class="fas fa-folder-plus"></i>
                                        Registrar
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @can('categoria.destroy')
                                                     <form action="{{ url('/categoria/' . $categoria->id) }}" id="form-eliminar" class="d-inline"
                                                        method="POST">
                                                        @csrf
                                                        {{method_field('DELETE')}}
