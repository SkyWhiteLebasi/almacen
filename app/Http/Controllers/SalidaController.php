...
class SalidaController extends Controller
{
    ...
    public function pdf()
    {
        $salidas= DB::select('SELECT salidas.id, productos.nombre_pr, salidas.cant_salida, salidas.fecha_salida, salidas.contador_salida, salidas.obs_salida from salidas
    ...
    public function pdf_nutricion()
    {
        ...
        // return view('salida.nutricion',compact('nutricion') );
    ...
    public function store(Request $request)
    {
        ...
        $campos=[
            ...
            'cant_salida_val' =>'nullable|integer',
    ...
    public function update(Request $request, $id)
    {
        $campos=[
            'producto_id' =>'required|integer',
            'cant_salida' =>'nullable|integer',
            'obs_salida' =>'nullable|string|max:100000',
            'fecha_salida' =>'nullable|string|max:100000',
            'contador_salida' =>'nullable|string|max:100000',
        ];
